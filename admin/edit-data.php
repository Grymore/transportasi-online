...
<div class="container my-5">
  ...
  <form action="../includes/edit-data.php?email=<?=$_GET['email']?>" method="POST" accept-charset="utf-8">
    <?php
    ...
    <div class="form-group my-2 row">
      <input class="form-control form-control-lg" type="email" placeholder="Email" required="" name="email" value="<?=$data['email']?>">
    </div>
    <div class="form-group my-2 row">
    ...
    <div class="my-2 row">
      ...
      <a class="btn btn-lg btn-primary form-control btn-block" href="data-pendaftar.php">Batal</a>
    </div>
    <?php
