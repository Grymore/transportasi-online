...
<div class="container my-5">
  ...
  <form action="includes/daftar.php" method="POST" accept-charset="utf-8">
    ...
    <br>
    <div>
      <input type="checkbox" name="" required=""> <p>Dengan mencentang checkbox diatas saya telah meensetujui kebijakan daftar online ini.</p>
    </div>
    <br>
    <div class="my-2 row">
      <button type="submit" class="btn btn-lg btn-info form-control btn-block" name="daftar">Daftar</button>
    </div>
